 ...
 *
 *    Description:  5.30 - Create a five question multiple choice quiz on global
 *                  warming, each question having four possible answers
 *                  (numbered 1-4).
 *                  Next write an application that administers the quiz,
 *                  calculates the number of correct answers (zero through five)
 *                  and returns a message to the user.
 *                  If the user correctly answered
 *                  five questions print "Excellent"
 *                  four questions print "Very good"
 *                  three or fewer print "Time to brush up on your knowledge of
 *                  global warming".
 *
 *                  Also include a list of some of the websites where you found
 *                  your facts.
 *
 *

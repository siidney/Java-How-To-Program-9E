 ...
 *       Filename:  Time2.java
 *
 *    Description:  8.5 - Modifiy the Time2 class of fig 8.5 to implement the
 *                  Time2 as the numeber of seconds since midnight and show
 *                  that no change is visible to the clients of the class.
 *

 ...
 *
 *    Description:  6.36 - Modify 6.35 so that various comments are displayed
 ...
 *                      "Don't give up."
 *                      "No. Keep Trying."
 *                  Use random number generation to choose a number from 1 to 4
 *                  that will be used to select one of the four appropriate
 *                  responses to each correct or incorrect answer.

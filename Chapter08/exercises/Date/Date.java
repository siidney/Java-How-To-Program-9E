 ...
 *       Filename:  Date.java
 *
 *    Description:  8.14 - Create class date with the following capabilities:
 *                  a) Output the date in multiple formats:
 *                      MM/DD/YYYY
 *                      June 14, 1992
 *                      DDDD YYYY
 *                  b) Use overloaded constructors to create Date objects
 *                  initialised with dates of the formats in part(a).
 *                  In the first case the constructor should receive three
 *                  integer values.
 *                  In the second case it should receive a String and two
 *                  integer values.
 *                  In the third case it should receive two integer values, the

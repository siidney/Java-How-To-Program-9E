 ...
 *       Filename:  GUI.java
 *
 *    Description:  14.15 - Write an application that enables the user to
 *                  generate and process every event described in this chapter.
 *                  The application should provide methods from the
 *                  ActionListener, ItemListener, ListSelectionListener,
 *                  MouseListener, MouseMotionListener and KeyListener
 *                  interfaces to display message when the events occur.
 *                  Use method toString to convert the event objects received in
 *                  each event handler into Strings that can be displayed.
 *                  Method toString creates a String containing all the

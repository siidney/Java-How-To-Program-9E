 ...
 *
 *    Description:  4.31 - Write an application that inputs a binary integer and
 *                  prints its decimal equivalent.
 *
 *                  Calculates binary from right to left adding the
 *                  place^2 to the total to get the decimal conversion.
 *

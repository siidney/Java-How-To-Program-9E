 ...
 *
 *    Description:  6.31 - Modify the program of 6.30 to count the number of
 *                  guesses the player makes.
 *                  Print the following for each number:
 *                  <= 10 - "Either you know the secret or you got lucky!"
 *                  == 10 - "Aha! You know the secret!"
 *                  > 10  - "You should be able to do better!".
 *
